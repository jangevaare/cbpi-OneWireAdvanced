        ...
        if not 0.0 < alpha <= 1.0:
            ...
            while self.is_running():
                ...
                try:
                    ...
                    warn_count += 1
                    cbpi.notify("OneWire Warning", "Exception encountered when getting temperature of %s" % address, type="warning")
                    cbpi.app.logger.info("[%s] Exception with %s" % (waketime, address))
